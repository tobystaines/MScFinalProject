...
def cfg():
    model_config = {'saving': True,  # Whether to take checkpoints
                    ...
                    'EPOCHS': 14,  # Number of full passes through the dataset to train for
...
def do_experiment(model_config):
    ...
    model = audio_models.Audio_Model(mixed_mag, voice_mag, mixed_phase, mixed_audio, voice_audio, 'unet', is_training, name='U_Net_Model')
